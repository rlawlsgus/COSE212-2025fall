...
class Spec extends SpecBase {
  ...
  test(eval("let z = (fun x -> x) in [1; 2; z; 5] = [1; 2; z; 5]"), "false")
  test(eval("(1 = 1) = (2 = 2)"), "true")
  ...
  test(eval("let x = true in [[1]; 1; x]"), "[[1]; 1; true]")
  test(eval("let x = 42 in x + 1"), "43")
  test(eval("let x = 1 in let y = 2 in let y = 3 in x + y"), "4")
  ...
  test(eval("let (1, 2, 3) = (1, 2, 3) in 1"), "1")
  ...
  test(eval("let rec g a = a + 1 and g b = b + 2 in g 3"), "5")
